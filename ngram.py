...
english = NGram(u"The woman drank milk", n=3)
french = NGram(u"La femme boit du lait", n=3)
chinese = NGram(u"女性喝牛奶", n=3)
japanese = NGram(u"女性が牛乳を飲んだ", n=3)
...
text = u"me"
print(languages.get(NGram(text, n=3).best_match(languages.keys())))
